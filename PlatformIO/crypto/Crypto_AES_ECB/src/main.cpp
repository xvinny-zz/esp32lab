...
void setup() 
{
    ...
    // char key[] = {0x72, 0xb8, 0x8c, 0x04, 0x9f, 0x5e, 0x9f, 0xd2, 0xcf, 0xc3, 0xb9, 
    //               0xa5, 0x34, 0x4d, 0x9e, 0x3b, 0xd6, 0x34, 0x19, 0x79, 0x9f, 0xc4, 
    //               0xa2, 0xbe, 0x7d, 0xc4, 0xe2, 0x78, 0xe2, 0xab, 0x8a, 0x01}; // 256-bit (32 bytes)

    char key[] = {0x72, 0xF9, 0x52, 0xCB, 0x2C, 0x65, 0x9C, 0xB8, 0x14, 0x81, 0xF1, 
                  0x67, 0x98, 0xBC, 0x1C, 0xEB, 0x0E, 0x3D, 0x26, 0x6E, 0x6C, 0xE7, 
                  0xAD, 0x9C, 0x0D, 0xD1, 0xF4, 0x59, 0xDF, 0x30, 0xDF, 0xD1};

    char iv[] = {0x66, 0x18, 0x3E, 0x8D, 0x38, 0xD5, 0x11, 0xB9, 
                 0x38, 0x46, 0xE8, 0xEA, 0xE7, 0x7F, 0xEA, 0x57};

 ...
 * platforms.  NANOGPS configurations will use slightly more RAM, and on
...
// be used in the rest of the NANOGPS package.  Do not change these defines.
  ...
  #define NANOGPS_PACKED __attribute__((packed))

#else

  // Let the compiler do whatever it wants.

  #define NANOGPS_PACKED
  #define NANOGPS_BF(b)
